        ...
        <form method="post" action="resultado_cramer.php" id="form">
            ...
            <div class="matriz-wrapper">
                ...
                <div class="botoes-box">
                    <button type="button" class="button is-custom-verdeclaro is-rounded no-shadow" onclick="alterarMatriz('add')">+</button>
                    <button type="button" class="button is-custom-verdeclaro is-rounded no-shadow" onclick="alterarMatriz('remove')">-</button>
                    <button type="button" class="button is-custom-verdeclaro is-rounded no-shadow" onclick="limparMatriz()">Limpar</button>
                </div>
            </div>
